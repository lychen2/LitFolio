...
\begin{enumerate}
  ...
  \item \textbf{LLM Answer}---The system prompt enforces: answer only based on the provided
    evidence, annotate each fact with a \cmd{[N]} citation reference; when retrieved papers are
    not directly relevant, the LLM honestly states "these papers do not directly address your
    question." Answers are rendered in rich Markdown format (bold, italic, lists, headings).
\end{enumerate}
