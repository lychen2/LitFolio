...
pub const GENERIC_STOPWORDS: &[&str] = &[
    ...
    "and", "or", "but", "nor", "yet", "so", "if", "then", "than", "though",
    ...
    "who", "whom", "whose", "which", "what", "whatever", "whoever", "when",
    "where", "while", "why", "how",
    "all", "another", "any", "both", "each", "either", "every", "few", "many",
    "more", "most", "much", "neither", "no", "none", "other", "others",
    "several", "some", "such",
    ...
    "approach", "based", "data", "method", "methods", "model", "models",
    "paper", "papers", "result", "results", "show", "shows", "showed", "shown",
    "study", "studies", "use", "uses", "used", "using", "work", "works",
    "thing", "things", "case", "cases", "way", "ways", "form", "forms",
    "type", "types", "kind", "kinds", "lot", "lots", "part", "parts",
    "etc", "i.e", "e.g",
];
...
const MIDDLE_BANNED: &[&str] = &[
    ...
    "toward", "towards", "through", "throughout",
