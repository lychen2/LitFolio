...
export const en: Record<TKey, string> = {
  ...
  "nav.topic": "Discover",
  "nav.ask": "Ask",
  "plugins.disabled": "The \"{name}\" plugin is disabled. Enable it in Settings to use this feature.",
  ...
  "common.loadFailed": "Could not load. Try again.",
  ...
  "common.none": "None",
  "common.projectRequired": "Select a project first",
  ...
  "compare.title": "Paper comparisons",
  "compare.subtitle": "Review, edit, and reuse AI-generated multi-paper comparison reports.",
  "compare.empty": "No comparisons yet. Select at least two papers in the Library and compare them.",
  "compare.select": "Select a comparison from the sidebar",
  "compare.papersCompared": "{count} papers compared",
  "compare.modelCreated": "Model: {model} · Created {date}",
  "compare.edit": "Edit",
  "compare.save": "Save",
  "compare.delete": "Delete comparison",
  ...
  "settings.plugins.subtitle": "Enable or disable optional features. Disabled plugins hide their pages and contributions.",
  "settings.plugins.enabled": "Enabled",
  "settings.plugins.disabled": "Disabled",
  "settings.plugins.empty": "This build has no configurable plugins.",
  ...
  "settings.profile.pullModel": "📥 Pull",
  "settings.profile.pullModelTitle": "Download/pull this model weight via local Ollama",
  ...
  "settings.zotero.title": "Sync to Zotero",
  "settings.zotero.hint": "Send selected paper metadata and AI reading content to a Zotero collection. Zotero desktop must be running.",
  "settings.zotero.target": "Target collection",
  "settings.zotero.choose": "Choose a Zotero collection",
  "settings.zotero.loadFirst": "Load Zotero collections first",
  "settings.zotero.loadTargets": "Load collections",
  "settings.zotero.save": "Save target",
  "settings.zotero.test": "Test connection",
  "settings.zotero.saved": "✓ Zotero target saved.",
  "settings.zotero.connected": "✓ Zotero connected.",
  "library.sendToZotero": "Send to Zotero",
  "library.sendToZoteroBatch": "Send to Zotero",
  "library.zoteroPushed": "Sent {count} paper(s) to Zotero.",
  "library.zoteroSkipped": "Skipped {count} paper(s) already sent.",
  "library.zoteroRepushConfirm": "{count} paper(s) were already sent. Send them again and create new Zotero items?",
  "library.zoteroError.notConfigured": "No Zotero target collection selected. Configure it in Settings → Sync → Sync to Zotero.",
  "library.zoteroError.unreachable": "Cannot reach Zotero. Make sure Zotero desktop is running.",
  "library.zoteroError.generic": "Zotero push failed: {message}",
  ...
  "reader.backToPreviousPositionTitle": "Back to previous reading position",
  ...
  "reader.doiAutoDownload": "Auto-download PDF",
  "reader.doiAutoDownloadFailed": "Auto-download failed: {message}. You can choose a local PDF instead.",
  ...
  "reader.noteColorTitle": "Note color",
  "reader.noteOpacityTitle": "Note opacity",
  "reader.noteResetStyleTitle": "Reset note style",
  "reader.standaloneNote": "PDF text note",
  ...
  "obsidian.title": "Obsidian vault",
  "obsidian.description": "Sync converted paper text and metadata to Obsidian after PDF import, with automatic updates for new conversions.",
  "obsidian.vaultLabel": "Vault directory",
  "obsidian.vaultPlaceholder": "Choose an Obsidian vault directory…",
  "obsidian.browse": "Browse…",
  "obsidian.folderLabel": "Paper folder",
  "obsidian.folderHint": "Use a relative path inside the vault, such as Papers or Research/Papers.",
  "obsidian.saveHint": "Sync also saves the current vault settings.",
  "obsidian.syncAll": "Sync existing papers",
  "obsidian.syncDone": "✓ Synced {exported} papers, skipped {skipped}",
  ...
  "theme.description": "Choose a dark theme for the current research environment. Your preference stays on this device.",
  "theme.violet": "Muted violet",
  "theme.violetHint": "LitFolio's default identity, balanced for reading and research tools.",
  "theme.warm": "Graphite paper",
  "theme.warmHint": "Warm text and amber annotation accents for long reading sessions.",
  "theme.blueprint": "Cold blueprint",
  "theme.blueprintHint": "Cool structure with cyan data states for graphs and analysis.",

  "theme.fontTitle": "Interface font",
  "theme.fontDescription": "Choose the font family for the application interface.",
  "theme.fontRounded": "Soft Rounded",
  "theme.fontRoundedHint": "Cute and gentle rounded typography",
  "theme.fontSystem": "System Sans",
  "theme.fontSystemHint": "Standard clean system sans-serif",
  "theme.fontSerif": "Elegant Serif",
  "theme.fontSerifHint": "Classic book-like serif styling",
  "theme.fontMono": "Geek Mono",
  "theme.fontMonoHint": "Monospaced technical font styling",

  "theme.fontSizeTitle": "Interface font size",
  "theme.fontSizeDescription": "Scale global interface text and layout proportions.",
  "theme.fontSizeSm": "Compact (14px)",
  "theme.fontSizeMd": "Standard (16px)",
  "theme.fontSizeLg": "Comfort (18px)",
  "theme.fontSizeXl": "Large (20px)",
  ...
  "graph.noConcepts": "No concept nodes yet. Extract terms from papers first.",
  "graph.legend": "Legend",
  "graph.conceptRunSummary": "Extracted {concepts} concepts from {succeeded}/{total} papers.",
  "graph.conceptRunFailures": "{summary} Failed {count}: {details}",
  "graph.noGraphHint":
